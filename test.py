...
from kivy.lang import Builder  # Needed to fix the keyboard crash

# --- FORUM-APPROVED KEYBOARD FIX ---
# This "Rule" sets the size safely without overwriting Kivy's internal properties.
Builder.load_string('''
<VKeyboard>:
    height: dp(220)
    key_margin: dp(4)
